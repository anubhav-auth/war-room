...
export default function HotLeads({ contacts }: { contacts: (Contact & { companies: Company | null })[] }) {
          ...
          <div key={contact.id} className="bg-white p-4 rounded-lg shadow-sm border border-orange-200 hover:shadow-md transition-shadow relative">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-sm text-gray-500">{contact.companies?.name || 'Auto-discovery...'}</p>
              </div>
